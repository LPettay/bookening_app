...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/debuggerMixin/debuggerMixin.js
var debuggerMixin = h((superclass) => {
  var _DebuggerMixinClass_instances, _DebuggerMixinClass_debuggerEle, _DebuggerMixinClass_disableDebugger, _DebuggerMixinClass_enableDebugger, _DebuggerMixinClass_handleDebugMode, _DebuggerMixinClass_updateDebuggerMessages, _a;
  return _a = class DebuggerMixinClass extends r(initLifecycleMixin, loggerMixin)(superclass) {
    constructor() {
      super(...arguments);
  ...
  }, _DebuggerMixinClass_debuggerEle = /* @__PURE__ */ new WeakMap(), _DebuggerMixinClass_instances = /* @__PURE__ */ new WeakSet(), _DebuggerMixinClass_disableDebugger = function _DebuggerMixinClass_disableDebugger2() {
    var _b;
  ...
  }, _DebuggerMixinClass_enableDebugger = async function _DebuggerMixinClass_enableDebugger2() {
    ...
    await import("./debugger-wc-XU3EQMWF.js");
    document.body.appendChild(__classPrivateFieldGet(this, _DebuggerMixinClass_debuggerEle, "f"));
  }, _DebuggerMixinClass_handleDebugMode = function _DebuggerMixinClass_handleDebugMode2() {
    if (this.debug)
  ...
  }, _DebuggerMixinClass_updateDebuggerMessages = function _DebuggerMixinClass_updateDebuggerMessages2(title, description) {
    var _b;
    if (title)
...
// node_modules/@descope/sdk-component-drivers/dist/index.esm.js
var i2;
var r2;
var n2 = class {
  constructor(t, l) {
    i2.set(this, void 0), this.nodeName = "", __classPrivateFieldSet(this, i2, t, "f"), this.logger = l.logger;
  }
  get asyncEle() {
    return (async (e, t) => new Promise((l) => {
      const i3 = setInterval(() => {
        const t2 = "function" == typeof e ? e() : e;
        t2 && (clearInterval(i3), l(t2));
      }, 100);
      setTimeout(() => {
        clearInterval(i3), l(null);
      }, t);
    }))(__classPrivateFieldGet(this, i2, "f"), 1e3);
  }
  get ele() {
    var e, l;
    const r3 = "function" == typeof __classPrivateFieldGet(this, i2, "f") ? __classPrivateFieldGet(this, i2, "f").call(this) : __classPrivateFieldGet(this, i2, "f");
    return r3 ? (null == r3 ? void 0 : r3.localName) !== this.nodeName ? (null === (l = this.logger) || void 0 === l || l.debug(`node name do not match, expected "${this.nodeName}", received "${r3.localName}" `, Error()), null) : r3 : (null === (e = this.logger) || void 0 === e || e.debug(`Driver element is not available for ${this.nodeName}`, new Error()), null);
  }
};
i2 = /* @__PURE__ */ new WeakMap();
var s = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-apps-list";
  }
  set data(e) {
    this.ele && (this.ele.data = e);
  }
  get data() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.data;
  }
  get ele() {
    return super.ele;
  }
...
var o = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-avatar";
  }
  set displayName(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("display-name", e);
  }
  set image(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("img", e);
  }
  get flowId() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("flow-id");
  }
  onClick(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("click", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("click", e);
    };
  }
};
var d = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-button";
  }
  onClick(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("click", e), () => {
  ...
  disable() {
    var e;
    null === (e = this.ele) || void 0 === e || e.setAttribute("disabled", "true");
  }
  enable() {
    var e;
    null === (e = this.ele) || void 0 === e || e.removeAttribute("disabled");
  }
};
var u = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-wc";
  }
  set projectId(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("project-id", e);
  }
  set baseUrl(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("base-url", e);
  }
  set flowId(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("flow-id", e);
  }
  set theme(e) {
    var t, l;
    e ? null === (l = this.ele) || void 0 === l || l.setAttribute("theme", e) : null === (t = this.ele) || void 0 === t || t.removeAttribute("theme");
  }
  onSuccess(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("success", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("success", e);
    };
  }
  onPageUpdated(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("page-updated", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("page-updated", e);
    };
  }
};
var a = class extends d {
  ...
  get enableMode() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("enable-mode");
  }
};
var v = /^descope-grid-([^-]+)-column$/;
var c = { text: class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-grid-text-column";
  }
  onSortDirectionChange(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("direction-changed", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("selected-items-changed", e);
    };
  }
}, custom: class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-grid-custom-column";
  }
  onSortDirectionChange(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("direction-changed", e), () => {
...
var h2 = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-grid", r2.set(this, void 0);
  }
  onSelectedItemsChange(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("selected-items-changed", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("selected-items-changed", e);
    };
  }
  ...
  get columns() {
    return this.ele ? Array.from(this.ele.children).reduce((e, t) => {
      var l;
      const i3 = null === (l = v.exec(t.localName)) || void 0 === l ? void 0 : l[1], r3 = c[i3];
      return r3 ? (e.push(new r3(t, { logger: this.logger })), e) : e;
    }, []) : [];
  }
  filterColumns(e) {
    var i3, n3;
    const s2 = null === (i3 = this.ele.columns) || void 0 === i3 ? void 0 : i3.filter(e);
    s2 && this.ele.columns && (i(s2, this.ele.columns) || (this.ele.columns = s2, null === (n3 = __classPrivateFieldGet(this, r2, "f")) || void 0 === n3 || n3.call(this, s2)));
  }
  onColumnsChange(t) {
    __classPrivateFieldSet(this, r2, t, "f");
  }
  set renderColumn(e) {
    this.ele.renderColumn = e;
  }
};
r2 = /* @__PURE__ */ new WeakMap();
var m = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-link";
  }
  get ele() {
    return super.ele;
  }
  get href() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("href");
  }
  set href(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("href", null != e ? e : "");
  }
};
var p;
var g = class extends n2 {
  constructor() {
    super(...arguments), p.set(this, void 0), this.nodeName = "descope-modal";
  }
  close() {
    var e, t;
    null === (e = this.ele) || void 0 === e || e.removeAttribute("opened"), null === (t = this.afterClose) || void 0 === t || t.call(this);
  }
  async open() {
    var e, t;
    await (null === (e = this.beforeOpen) || void 0 === e ? void 0 : e.call(this)), null === (t = this.ele) || void 0 === t || t.setAttribute("opened", "true");
  }
  reset() {
    var e;
    this.ele && (this.ele.innerHTML = ""), __classPrivateFieldGet(this, p, "f") && (null === (e = this.ele) || void 0 === e || e.append(__classPrivateFieldGet(this, p, "f").content.cloneNode(true)));
  }
  setContent(t) {
    __classPrivateFieldSet(this, p, t, "f"), this.reset();
  }
  remove() {
    var e;
    null === (e = this.ele) || void 0 === e || e.remove();
  }
};
p = /* @__PURE__ */ new WeakMap();
var b = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-multi-select-combo-box";
  }
  async setData(e) {
    var t;
    null === (t = await this.asyncEle) || void 0 === t || t.setAttribute("data", JSON.stringify(e.sort()));
  }
};
var f = class extends n2 {
  ...
  close() {
    var e;
    null === (e = this.ele) || void 0 === e || e.removeAttribute("opened");
  }
  show() {
    var e;
    null === (e = this.ele) || void 0 === e || e.setAttribute("opened", "true");
  }
  setContent(e) {
    this.ele.innerHTML = "", this.ele.appendChild(e.content.cloneNode(true));
  }
  remove() {
    var e;
    null === (e = this.ele) || void 0 === e || e.remove();
...
var A = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-combo-box";
  }
  onInput(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("input", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("input", e);
    };
  }
  get value() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.value;
  }
  set value(e) {
    this.ele && (this.ele.value = e);
  }
  async setData(e) {
    var t;
    null === (t = await this.asyncEle) || void 0 === t || t.setAttribute("data", JSON.stringify(e.sort()));
...
var L = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-text";
  }
  get ele() {
    return super.ele;
  }
  get text() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.innerText;
  }
  set text(e) {
    this.ele && (this.ele.innerText = e);
  }
};
var x = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-text-field";
  }
  onInput(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("input", e), () => {
...
var k = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-user-attribute";
  }
  set value(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("value", e);
  }
  set badgeLabel(e) {
    var t;
    null === (t = this.ele) || void 0 === t || t.setAttribute("badge-label", e);
  }
  get label() {
    var e;
    return (null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("label")) || "";
  }
  get editFlowId() {
    var e;
    return (null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("edit-flow-id")) || "";
  }
  get deleteFlowId() {
    var e;
    return (null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("delete-flow-id")) || "";
  }
  onEditClick(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("edit-clicked", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("edit-clicked", e);
    };
  }
  onDeleteClick(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("delete-clicked", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("delete-clicked", e);
    };
  }
};
var w = class extends n2 {
  constructor() {
    super(...arguments), this.nodeName = "descope-user-auth-method";
  }
  set fulfilled(e) {
    var t, l;
    e ? null === (t = this.ele) || void 0 === t || t.setAttribute("fulfilled", "true") : null === (l = this.ele) || void 0 === l || l.removeAttribute("fulfilled");
  }
  onUnfulfilledButtonClick(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("button-clicked", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("button-clicked", e);
    };
  }
  onFulfilledButtonClick(e) {
    var t;
    return null === (t = this.ele) || void 0 === t || t.addEventListener("fulfilled-button-clicked", e), () => {
      var t2;
      return null === (t2 = this.ele) || void 0 === t2 ? void 0 : t2.removeEventListener("fulfilled-button-clicked", e);
    };
  }
  get flowId() {
    var e;
  ...
  get fulfilledFlowId() {
    var e;
    return null === (e = this.ele) || void 0 === e ? void 0 : e.getAttribute("fulfilled-flow-id");
  }
};

// node_modules/@descope/sdk-mixins/dist/esm/mixins/modalMixin/constants.js
var MODAL_ELE_TAG = "descope-modal";

// node_modules/@descope/sdk-mixins/dist/esm/mixins/modalMixin/helpers.js
var createModalEle = (config = {}) => {
...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/modalMixin/modalMixin.js
var modalMixin = h((superclass) => {
  var _ModalMixinClass_ModalDriverWrapper, _a;
  const BaseClass = r(initLifecycleMixin, initElementMixin, descopeUiMixin)(superclass);
  return _a = class ModalMixinClass extends BaseClass {
    constructor() {
      ...
      _ModalMixinClass_ModalDriverWrapper.set(this, (() => {
        ...
        return class ModalDriverWrapper extends g {
          setContent(template) {
  ...
  }, _ModalMixinClass_ModalDriverWrapper = /* @__PURE__ */ new WeakMap(), _a;
});

// node_modules/@descope/sdk-mixins/dist/esm/mixins/notificationsMixin/constants.js
var NOTIFICATION_ELE_TAG = "descope-notification";

// node_modules/@descope/sdk-mixins/dist/esm/mixins/notificationsMixin/helpers.js
var createNotificationEle = (config = {}) => {
...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/notificationsMixin/notificationsMixin.js
var notificationsMixin = h((superclass) => {
  ...
  return _a = class NotificationsMixinClass extends BaseClass {
    constructor() {
      ...
      _NotificationsMixinClass_NotificationDriverWrapper.set(this, (() => {
        const loadDescopeUiComponents = this.loadDescopeUiComponents.bind(this);
        return class NotificationDriverWrapper extends f {
          setContent(templateOrString) {
            const template = typeof templateOrString === "string" ? n(templateOrString) : templateOrString;
            loadDescopeUiComponents(template);
            super.setContent(template);
          }
        };
  ...
  }, _NotificationsMixinClass_NotificationDriverWrapper = /* @__PURE__ */ new WeakMap(), _a;
});
...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/createStateManagementMixin.js
var createStateManagementMixin = (options) => h((superclass) => {
  const slice = createSlice(options);
  const allActions = Object.assign(Object.assign({}, slice.actions), options.asyncActions);
  return class StateManagementMixinClass extends r(loggerMixin)(superclass) {
    constructor(...args) {
      super(...args);
...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/formMixin.js
var formMixin = h((superclass) => class FormMixinClass extends loggerMixin(superclass) {
  ...
  disableFormField(rootEle, name) {
    var _a;
    (_a = this.getFormInputs(rootEle).find((input) => input.name === name)) === null || _a === void 0 ? void 0 : _a.setAttribute("disabled", "true");
  }
  removeFormField(rootEle, name) {
    var _a;
    (_a = this.getFormInputs(rootEle).find((input) => input.name === name)) === null || _a === void 0 ? void 0 : _a.remove();
  }
});

// node_modules/@descope/sdk-mixins/dist/esm/mixins/cookieConfigMixin.js
var cookieConfigMixin = h((superclass) => {
...
//# sourceMappingURL=chunk-XU36NMJB.js.map
