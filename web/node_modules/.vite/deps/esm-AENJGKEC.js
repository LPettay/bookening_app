...
var pt = r((e) => class extends gt(e) {
  init() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      var t;
      yield null === (t = e2.init) || void 0 === t ? void 0 : t.call(this);
      (customElements.get("descope-wc") || (yield import("./descope-wc-XBXU5462.js").then((t2) => t2.default))).sdkConfigOverrides = { baseHeaders: { "x-descope-widget-type": "tenant-profile-widget", "x-descope-widget-id": this.getAttribute("widget-id"), "x-descope-widget-version": "0.2.11" } };
    });
  }
})(HTMLElement);
...
//# sourceMappingURL=esm-AENJGKEC.js.map
