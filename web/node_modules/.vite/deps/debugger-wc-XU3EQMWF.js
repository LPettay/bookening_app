...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/debuggerMixin/helpers.js
var limitCoordinateToScreenBoundaries = (ele, x, y, boundaries = {}) => {
  var _a, _b, _c, _d;
  return [
    Math.min(Math.max(x, (boundaries.left === "all" ? ele.offsetWidth : (_a = boundaries.left) !== null && _a !== void 0 ? _a : 0) - ele.offsetWidth), window.innerWidth - (boundaries.right === "all" ? ele.offsetWidth : (_b = boundaries.right) !== null && _b !== void 0 ? _b : 0)),
    Math.min(Math.max(y, (boundaries.top === "all" ? ele.offsetHeight : (_c = boundaries.top) !== null && _c !== void 0 ? _c : 0) - ele.offsetHeight), window.innerHeight - (boundaries.bottom === "all" ? ele.offsetHeight : (_d = boundaries.bottom) !== null && _d !== void 0 ? _d : 0))
  ];
};
var dragElement = (ele, triggerEle, keepVisible) => {
  let deltaX = 0;
  let deltaY = 0;
  let currentX = 0;
  let currentY = 0;
...
var addOnResize = (ele) => {
  ele.onmousemove = (e) => {
    ...
    if (target.w && target.w !== target.offsetWidth || target.h && target.h !== target.offsetHeight) {
...
// node_modules/@descope/sdk-mixins/dist/esm/mixins/debuggerMixin/debugger-wc.js
var _Debugger_instances;
var _Debugger_messagesState;
var _Debugger_rootEle;
var _Debugger_contentEle;
var _Debugger_headerEle;
var _Debugger_eventsCbRefs;
var _Debugger_onNewMessages;
var _Debugger_renderMessages;
var _Debugger_setCollapsibleMessages;
var _Debugger_onWindowResize;
var INITIAL_POS_THRESHOLD = 32;
var INITIAL_WIDTH = 300;
var INITIAL_HEIGHT = 200;
var MIN_SIZE = 200;
...
`;
var icon = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
var BaseClass = r(injectStyleMixin)(HTMLElement);
var Debugger = class extends BaseClass {
  constructor() {
    var _a;
    super();
    _Debugger_instances.add(this);
    _Debugger_messagesState.set(this, new d({ messages: [] }));
...
_Debugger_messagesState = /* @__PURE__ */ new WeakMap(), _Debugger_rootEle = /* @__PURE__ */ new WeakMap(), _Debugger_contentEle = /* @__PURE__ */ new WeakMap(), _Debugger_headerEle = /* @__PURE__ */ new WeakMap(), _Debugger_eventsCbRefs = /* @__PURE__ */ new WeakMap(), _Debugger_instances = /* @__PURE__ */ new WeakSet(), _Debugger_onNewMessages = function _Debugger_onNewMessages2(data) {
...
}, _Debugger_renderMessages = function _Debugger_renderMessages2(data) {
  __classPrivateFieldGet(this, _Debugger_contentEle, "f").innerHTML = data.messages.map((message) => `
    <div class="msg">
      ${icon}
  ...
  `).join("");
}, _Debugger_setCollapsibleMessages = function _Debugger_setCollapsibleMessages2() {
...
}, _Debugger_onWindowResize = function _Debugger_onWindowResize2() {
...
//# sourceMappingURL=debugger-wc-XU3EQMWF.js.map
